...
for($i=0;$i<$size;$i++)
{
    $query_1="SELECT team_id,team_name FROM amz_teams where team_id='$avail_teams[$i]' AND team_deletion='0' ORDER BY team_name ASC";
            ...
            $.ajax({
                ...
                success: function(msg)
                {
                    ...
                    else
                    {
                        ...
                        $('#edit_team').foundation('reveal', 'close');
                    }
                }
            });
            filter();
