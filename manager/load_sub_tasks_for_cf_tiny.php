...
if($_POST['task_id']!="")
{
    ...
    $query_get_tasks="select sub_task_id,sub_task_name FROM amz_sub_tasks WHERE task_status='1' AND deletion='0' AND task_id='$task_id'  AND about_cf='1' ORDER BY sub_task_name ASC";
    ...
    <option value="">-- No sub tasks available --</option>
<?php }

}
else {
    echo "<option values='' disabled=''>-- Pls select task to view sub tasks --</option>";
}
