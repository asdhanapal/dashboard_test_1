...
//    echo $start_month=date("Y",$date_from);
//    $query_judge="SELECT * FROM amz_dt_manage WHERE month='$start_month'";
//    $result_judge_result= $conn->runsql($query_judge, $dbcon);
//
//    if(mysqli_num_rows($result_judge_result))
//    {
//        echo "<center></center>";
//    }
...
<!--        <td>Task desc</td>-->
        ...
        <td>Work units</td>
        <td>WU status</td>
       <!-- <td>Comments</td> onmouseover="alert('WU status in report is showing now for testing purpose only! It ll remove shortly.');"-->
        <td>On Time?</td>
        <td>Action</td>
...
//                            //Reader=wu=count*cf;
//                            //Renderer=wu=count*cf;
//                            //Auth=oring tools=??
//                            //KRF=wu=count*cf;
//                            //echo $wu=$count_wu*100/$con_fac;
//                            echo $wu=$count_wu*$con_fac;
//                            $tot_work_units+=$wu;
//                        }
//                        else
//                        {
