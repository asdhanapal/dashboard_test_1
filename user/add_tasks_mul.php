...
?>
<input type="hidden" name="team" id="team" value="<?php echo $_SESSION['team_id'] ?>">
<br>
<div class="row">
        ...
        <div class="panel">
            ...
            <div class="row">
                <div class="large-4 medium-4 columns">
                    ...
                    <input type="text" id="date" name="date" onchange="filter(); check_remaining_hrs(this.value);" placeholder="yyyy-mm-dd" required data-tooltip aria-haspopup="true" class="tip-top" title="Click inside and seelct the date from the date picker">
            ...
            <div class="row">
                <div class="large-11 medium-11 columns" align="right">
                ...
                <div class="large-1 medium-1 columns">
                    <a class="round-button" onclick="add_rows();" data-tooltip aria-haspopup="true" class="tip-top" title="Click to add more tasks">+</a>
                </div>
            </div>
        </div>
           </form>
