...
<!--<div class="panel">
    <div class="row">
    <div class="small-4 columns">Approved users:NA<?php //echo $dataapproved_users->total_app?></div>
    <div class="small-4 columns">Rejected users:NA<?php //echo $datarejected_users->total_rej?></div>
    <div class="small-4 columns">Pending users:NA<?php //echo $datapending_users->total_pend?></div>
</div></div>-->
    <?php
//}
?>
<table width="100%" class="tablesorter" >
    ...
    <?php
    $query = "SELECT * FROM amz_login WHERE user_deletion=0 ".$where_final." ORDER BY user_name ASC"; // AND ".$where;
    ...
    if (mysqli_num_rows($result)) {
        while ($result_row = mysqli_fetch_object($result)) {
            ...
            <td><?php echo $result_row->user_type!=4?get_teams($result_row->user_id,$team_array):"--"; ?></td>
            ...
            <td><a href="#" data-reveal-id="edit_user" data-reveal-ajax="<?php echo _BACK_TO_PRE_.COMMON.EDIT_USER_INFO."?val=".$result_row->user_id?>">Edit</a>&nbsp;&nbsp;&nbsp;Delete</td> 
        </tr>
        <?php
        $i++;
    }
...
<div id="edit_user" class="reveal-modal small" data-reveal>
