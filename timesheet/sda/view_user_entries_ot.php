...
$id=$_GET['val'];
$query = "SELECT * FROM user_tasks_ot WHERE task_id='$id'"; // AND ".$where;
...
<div class="Table">
    ...
    <div class="Row_even"><div class="Cell">OT Status</div><div class="Cell"><?php echo $status_array[$result_row->ot_status] ?></div></div>
    <div class="Row_odd"><div class="Cell">Action taken by</div><div class="Cell"><?php echo $result_row->act_by==""?"NA":$user_array[$result_row->act_by]?></div></div>
    <div class="Row_even"><div class="Cell">Admin Comments</div><div class="Cell"><?php echo $result_row->admin_cmds ?></div></div>
