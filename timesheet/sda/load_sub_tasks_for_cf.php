...
if($_POST['task_id']!="")
{
    ...
    $query_get_tasks="select sub_task_id,sub_task_name FROM amz_sub_tasks WHERE task_status='1' AND task_id='$task_id'  AND about_cf='1' ORDER BY sub_task_name ASC"; //AND deletion='0'
