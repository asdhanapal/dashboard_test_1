            ...
            <div class="row">
                ...
                <div class="small-9 columns">
                    ...
                    <!--<div class="small-2 columns">
                        <input type="radio" name="add_team" id="add_team" onclick="show_team();" checked><label>&nbsp;Add Team</label>
                    </div>-->
                    <div class="small-2 columns">
                        <label><input type="radio" name="add_team" id="add_task" onclick="show_task();" checked="">&nbsp;Add Task</label>
                    </div>
                    <div class="small-2 columns">
...
<!--            <div class="row" id="show_team">
            ...
            <div class="row" id="show_task">
                ...
                <div class="small-1 columns">
                    <select id="cf_type" required>
                        <option value="2">-- CF type --</option>
                        <option value="NULL">No CF</option>
                        <option value="0">Auto CF</option>
                        <option value="1">Manual CF</option>
                    </select>
                </div>
                
                <div class="small-2 columns">
                    <label>Have sub task?&nbsp;<input type="checkbox" name="decision_st" id="decision_st"  checked=""></label>
                    </div>
                <div class="small-2 columns">
                    
                    <label>Is operational task?&nbsp;<input type="checkbox" name="decision_ot" id="decision_ot" checked=""></label>
                    </div>
                
                <div class="small-2 columns">
                    <label data-tooltip aria-haspopup="true" class="tip-top" title="If the tasks divided to LC, MC and HC please check this.">have complexity?&nbsp;<input type="checkbox" name="decision_complexity" id="decision_complexity" ></label>
                    </div>
           ...
           <div class="row" id="show_st">
               ...
               <div class="small-1 columns">
                ...
                <div class="small-1 columns" id="complexity_deside">
...
function complexity()
{
        var complexity_decide=$("#task_1 option:selected").attr("itemref");
        if(complexity_decide==1)
        {
    ...
    function adding_tasks()
    {
        ...
        if($('#decision_complexity').is(":checked"))
            var complexity_status=1;
        else
            var complexity_status=0;
        
        $('.msgs').html('<img src="../img/loading.gif">');
        
        if(team=="" || task=="" || cf_type=="2")
        {
             $('.msgs').html('<font color=red>Please fill all fields!</font>');
             return false;
        }
        ...
        $.ajax({
            ...
            dataType: "json", 
            data: "team=" + team+"&task=" + task+"&st_status="+st_status+"&ot_status="+ot_status+"&cf_type="+cf_type+"&complexity="+complexity_status,
            success: function(msg)
            {
                if(msg[0]=='F')
                {
