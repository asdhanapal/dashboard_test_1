...
<?php
if($_POST['date']!="")
echo "<h5>Report on ".$_POST['date']." for ".$_SESSION['user_name']."</h5>";
else
...
<!--        <td>Last modify by</td>-->
    ...
    if (mysqli_num_rows($result)) {
        while ($result_row = mysqli_fetch_object($result)) {
            ...
            <td><?php echo $result_row->build!=0? $build_array[$result_row->build]:"N/A";?></td>
            ...
            <td><?php echo $result_row->time;
            $secs+= strtotime($result_row->time)-strtotime("00:00:00");?></td>
...
<!--            <td><?php //echo $result_row->modified_by!=""? $result_row->modified_by:"N/A"?></td>                <a href="#">Edit</a>&nbsp;&nbsp;-->
            ...
            <td><a href="#" data-reveal-id="myModal<?php echo $i ?>">View</a>&nbsp;&nbsp;<a href="#" onclick="del_ua('<?php echo $result_row->task_id?>');">Delete</a></td>
        </tr>
